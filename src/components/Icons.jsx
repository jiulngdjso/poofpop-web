// SVG Icon Components - Clean, modern design
export const Icons = {
  // Logo with gradient
  ...
  LogoGlow: ({ size = 48, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className}>
      ...
      <g filter="url(#glowFilter)">
        <circle cx="16" cy="16" r="14" stroke="url(#logoGradientGlow)" strokeWidth="2" />
        <circle cx="16" cy="16" r="8" fill="url(#logoGradientGlow)" opacity="0.2" />
        <circle cx="16" cy="16" r="5" fill="url(#logoGradientGlow)" />
        <circle cx="16" cy="16" r="2" fill="white" opacity="0.9" />
      </g>
    </svg>
  ),

  // Watermark removal icon
  ...
  Spinner: ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`icon-spinner ${className}`}>
